...
const int EXPONENT_SIZE = 32;
const int BASE_SIZE = 224;
...
class SuperInt {
  public:
    ...
    SuperInt &operator=(const ll &num) {
        ...
        this->num_[this->length_ - 2] =
            (unsigned int)(num >> 32) ^ (unsigned int)((num >> 63) << 31);
        return *this;
    }
...
class SuperFloat {
  public:
    ...
    friend SuperFloat operator+(const SuperFloat &, const SuperFloat &);
    friend SuperFloat operator-(const SuperFloat &, const SuperFloat &);
    friend SuperFloat operator*(const SuperFloat &, const SuperFloat &);
    friend SuperFloat operator/(const SuperFloat &, const SuperFloat &);
    ...
    friend bool operator==(const SuperFloat &, const SuperFloat &);
    friend bool operator!=(const SuperFloat &, const SuperFloat &);
    friend bool operator<(const SuperFloat &, const SuperFloat &);
    friend bool operator>(const SuperFloat &, const SuperFloat &);
    friend bool operator<=(const SuperFloat &, const SuperFloat &);
